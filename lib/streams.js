...
exports.effect = exports.derived = exports.stream = exports.atom = exports.Stream = exports.SourceStream = void 0;
let context = null;
...
const effect = (map) => (0, exports.stream)(() => map);
exports.effect = effect;
let count = 0;
exports.default = (func) => withContext([count++, 0], null, () => {
    const stream = (0, exports.effect)(func());
    stream.start();
    return () => stream.stop();
});
