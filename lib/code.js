...
const doMember = (obj, optional, prop) => {
    ...
    if (typeof res !== "function")
        return res;
    return res.bind(Array.isArray(obj) && ["join"].includes(prop) ? (0, util_1.resolve)(obj, true) : obj);
};
...
exports.default = (code) => {
    ...
    return {
        ...
        run: (getValue) => {
            ...
            return (0, streams_1.derived)(() => func(getValue, doMember, doCall, util_1.resolve), code);
        },
    };
};
